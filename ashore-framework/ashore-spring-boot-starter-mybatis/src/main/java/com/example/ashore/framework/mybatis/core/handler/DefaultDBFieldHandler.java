package com.example.ashore.framework.mybatis.core.handler;

import com.example.ashore.framework.mybatis.core.dataobject.BaseDO;
...
public class DefaultDBFieldHandler implements MetaObjectHandler {
    ...
    public void updateFill(MetaObject metaObject) {
        ...
        if (Objects.isNull(modifyTime)) {
            setFieldValByName("updateTime", LocalDateTime.now(ZoneOffset.UTC), metaObject);
        }
