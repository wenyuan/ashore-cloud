package com.example.ashore.framework.mybatis.core.mapper;

import cn.hutool.core.collection.CollUtil;
import com.example.ashore.framework.common.pojo.PageParam;
import com.example.ashore.framework.common.pojo.PageResult;
import com.example.ashore.framework.common.pojo.SortablePageParam;
import com.example.ashore.framework.common.pojo.SortingField;
import com.example.ashore.framework.mybatis.core.util.JdbcUtils;
import com.example.ashore.framework.mybatis.core.util.MyBatisUtils;
...
public interface BaseMapperX<T> extends MPJBaseMapper<T> {
    ...
    default T selectOne(String field1, Object value1,
     ...
     *
     * @param entities 实体集合
     * @param size     每批次插入数量 Db.saveBatch 默认为 1000
     */
