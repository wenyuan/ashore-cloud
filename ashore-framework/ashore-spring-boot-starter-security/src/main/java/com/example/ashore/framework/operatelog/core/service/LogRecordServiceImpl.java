package com.example.ashore.framework.operatelog.core.service;

import com.example.ashore.framework.common.biz.system.logger.OperateLogCommonApi;
...
public class LogRecordServiceImpl implements ILogRecordService {
    ...
    private static void fillUserFields(OperateLogCreateReqDTO reqDTO) {
        // 使用 SecurityFrameworkUtils，因为要考虑，rpc、mq、job 等非 Web 场景
    ...
    public static void fillModuleFields(OperateLogCreateReqDTO reqDTO, LogRecord logRecord) {
        ...
        reqDTO.setAction(logRecord.getAction());// 操作内容，例如：修改编号为 1 的用户信息，将性别从男改成女，将姓名从AAA改成BBB。
