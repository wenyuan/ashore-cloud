...
public class AshoreWebSecurityConfigurerAdapter {
    ...
    protected SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        // 登录功能暂时不使用 Spring Security 的扩展点机制，而是我们自己实现登录逻辑（@see AuthController.java / AppAuthController.java）
        // 主要基于以下两个考虑：
        // - 如果使用 Spring Security 的扩展点来实现多种用户类型（如：管理员、普通用户等）和多种登录方式（如：账号密码、手机验证码、微信登录等），实现会比较复杂
        // - Spring Security 的扩展点机制（如 AuthenticationProvider、UserDetailsService 等）学习成本比较高
        ...
        httpSecurity
                ...
                .authorizeHttpRequests(c -> c
                    ...
                    // 1.3 基于 ashore.security.permit-all-urls 无需认证
