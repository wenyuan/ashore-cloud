package com.example.ashore.framework.encrypt.core.filter;
...
import com.example.ashore.framework.common.util.object.ObjectUtils;
import com.example.ashore.framework.common.util.servlet.ServletUtils;
import com.example.ashore.framework.encrypt.config.ApiEncryptProperties;
import com.example.ashore.framework.encrypt.core.annotation.ApiEncrypt;
...
import static com.example.ashore.framework.common.exception.util.BusinessExceptionUtils.invalidParamException;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
        ...
        if (ObjectUtils.equalsAny(HttpMethod.valueOf(request.getMethod()),
            ...
            try {
                ...
                ApiResponse<?> result = globalExceptionHandler.allExceptionHandler(request, ex);
