package com.example.ashore.framework.swagger.config;
...
import static com.example.ashore.framework.web.core.util.WebFrameworkUtils.HEADER_TENANT_ID;
...
public class AshoreSwaggerAutoConfiguration {
     ...
     *
     * 如果每个api的OperationId只取方法名，在多个class里面方法名称一样时，就会导致覆盖
     * 典型bug：app-api前缀不生效，都是使用admin-api
     */
